...
<article>
  ...
  <section>
    <h2>Overview</h2>
    <p>The coursework is structured as a prediction competition where teams submit a prediction file and accompanying code. You will apply machine learning techniques learned throughout the course to solve a real-world financial prediction problem.</p>
  ...
  <section>
    ...
    <table>
      <tbody>
        <tr>
          <td><strong>Competition Link</strong></td>
          <td>Coming soon</td>
        </tr>
        <tr>
  ...
  <section>
    ...
    <ul>
      <li><strong>Daily submission limits:</strong> Details coming soon</li>
      <li><strong>One team account:</strong> Each team should use a single account for submissions</li>
  ...
  <section>
    <h2>Deliverables</h2>
    <ul>
      <li><strong>Code repository / notebook:</strong> Complete, documented code that reproduces your results</li>
      <li><strong>Submission file:</strong> Prediction file in the required format</li>
    </ul>
  </section>
</article>
